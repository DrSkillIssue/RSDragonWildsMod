// ABI declarations from UE4SS f6d5f9425a31f3e3a4fd185b40148f5aa4d81a44.
// Source: UE4SS/include/Mod/CppUserModBase.hpp (MIT).
// Other nonvirtual registration methods and unrelated includes are omitted.
#pragma once
#include <memory>
#include <vector>
#include <string>
...
namespace RC
{
    ...
    class CppUserModBase
    {
      ...
      protected:
        RC_UE4SS_API auto register_keydown_event(Input::Key, const Input::ModifierKeyArray&, const std::function<void()>&, uint8_t custom_data = 0) -> void;
    };
}
